...
/* html.twig */
class __TwigTemplate_6f14976800ad0f1f6c9dc223d4825ca9925f0c2494ddf70c68401cdda938b2bf extends Template
{
    private $source;
    private $macros = [];
...
<nav class=\"navbar navbar-expand-lg navbar-light bg-light\">
    <div class=\"container\">
        ...
        echo "                    </a>
                ...
                <li class=\"nav-item";
        // line 43
        if ($this->env->getRuntime('Slim\Views\TwigRuntimeExtension')->isCurrentUrl("exception-demo")) {
            echo " active";
        }
        echo "\">
                    <a class=\"nav-link\" href=\"";
        // line 44
        echo twig_escape_filter($this->env, $this->env->getRuntime('Slim\Views\TwigRuntimeExtension')->urlFor("exception-demo"), "html", null, true);
        echo "\">
                        Exception Demo
                        ";
        // line 46
