...
/* home.twig */
class __TwigTemplate_8e6bcd0c55ca9cdb7c7949a2c9ec3b7a2372ad492c457f9132e5c172124160b8 extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "
            ...
            <tr>
                ...
                <td>
                    ";
        // line 81
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $this->env->getRuntime('Slim\Views\TwigRuntimeExtension')->getUri(), "scheme", [], "any", false, false, false, 81), "html", null, true);
        echo "
                </td>
            </tr>
            </tbody>
...
";
    ...
    {
        return new Source("", "home.twig", "C:\\Users\\luck4\\OneDrive\\桌面\\slim\\slim4\\application\\templates\\home.twig");
    }
}
